        ...
        <script>
            $(document).ready(function () {
				...
				save();
                  ...
                  function save(){		
					if(flag==false){				  
					 var obj={"flag":0,"act": "saveRole","role":$("#role").val(),"desc":$("#desc").val(),"rid":0};
					 var save = {
                    type: "POST",
                    datatype: "json",
                    url: "api.php",
            ...
            {
                 var obj={"act": "editRole","roleId":id};
					 var edit = {
                    type: "POST",
                    datatype: "json",
                    url: "api.php",
            ...
            function edSaveRole(id){	
					
					 var obj={"flag":1,"act":"saveRole","role":$("#role").val(),"desc":$("#desc").val(),"rid":id};
					 var edsave = {
                    type: "POST",
                    datatype: "json",
                    url: "api.php",
